...
See also the source code of [Depecher](https://github.com/blacksailer/depecher) – a Telegram app for Sailfish OS, and [TELEports](https://gitlab.com/Flohack74/teleports) – a Qt-client for Ubuntu touch, both of which are based on TDLib.
